      ...
      <section className="career-journey-section">
        <div className="career-journey-viewport">
          ...
          <div className="career-journey-graphic">
            ...
            >
              {/* Step 1 to 2 */}
              <path d="M 115 64 Q 182.5 77 250 90" fill="none" stroke="#8b5cf6" strokeWidth="2.5" strokeDasharray="5 5" />
              {/* Step 2 to 3 */}
              <path d="M 250 90 Q 309 83 368 77" fill="none" stroke="#10b981" strokeWidth="2.5" strokeDasharray="5 5" />
              {/* Step 3 to 4 */}
              <path d="M 368 77 Q 424 70 480 64" fill="none" stroke="#06b6d4" strokeWidth="2.5" strokeDasharray="5 5" />
              {/* Step 4 to 5 */}
              <path d="M 480 64 Q 539 57 598 51" fill="none" stroke="#8b5cf6" strokeWidth="2.5" strokeDasharray="5 5" />
              {/* Step 5 to 6 */}
              <path d="M 598 51 Q 661 44 724 38" fill="none" stroke="#f59e0b" strokeWidth="2.5" strokeDasharray="5 5" />
              {/* Step 6 to 7 */}
              <path d="M 724 38 Q 809.5 25 895 13" fill="none" stroke="#eab308" strokeWidth="2.5" strokeDasharray="5 5" />
            </svg>

            {/* Step 1 Node */}
            <div className="journey-step-node step-1" style={{ left: '11.5%', top: '20%', '--step-color': '#8b5cf6', '--step-shadow': 'rgba(139, 92, 246, 0.25)', '--step-hover-bg': '#f5f3ff' } as React.CSSProperties}>
            ...
            {/* Step 2 Node */}
            <div className="journey-step-node step-2" style={{ left: '25%', top: '28%', '--step-color': '#8b5cf6', '--step-shadow': 'rgba(139, 92, 246, 0.25)', '--step-hover-bg': '#f5f3ff' } as React.CSSProperties}>
              <div className="journey-step-circle">
            ...
            {/* Step 3 Node */}
            <div className="journey-step-node step-3" style={{ left: '36.8%', top: '24%', '--step-color': '#10b981', '--step-shadow': 'rgba(16, 185, 129, 0.25)', '--step-hover-bg': '#ecfdf5' } as React.CSSProperties}>
              <div className="journey-step-circle">
            ...
            {/* Step 4 Node */}
            <div className="journey-step-node step-4" style={{ left: '48%', top: '20%', '--step-color': '#06b6d4', '--step-shadow': 'rgba(6, 182, 212, 0.25)', '--step-hover-bg': '#ecfeff' } as React.CSSProperties}>
              <div className="journey-step-circle">
            ...
            {/* Step 5 Node */}
            <div className="journey-step-node step-5" style={{ left: '59.8%', top: '16%', '--step-color': '#8b5cf6', '--step-shadow': 'rgba(139, 92, 246, 0.25)', '--step-hover-bg': '#f5f3ff' } as React.CSSProperties}>
              <div className="journey-step-circle">
            ...
            {/* Step 6 Node */}
            <div className="journey-step-node step-6" style={{ left: '72.4%', top: '12%', '--step-color': '#f59e0b', '--step-shadow': 'rgba(245, 158, 11, 0.25)', '--step-hover-bg': '#fffbeb' } as React.CSSProperties}>
              <div className="journey-step-circle">
